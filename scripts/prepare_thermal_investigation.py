"""Explicitly refresh the merged app's public numerical snapshots from this repo."""
...
target = root / "flower-app/fusion_agent/thermal/_closure.py"
...
devices_path = root / "flower-app/fusion_agent/thermal/_devices.json"
